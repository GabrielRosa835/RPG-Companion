...
public static class Results
{
    ...
    public static Maybe<T> Perhaps<T>(T? value) => Maybe<T>.Perhaps(value);
    public static Maybe<T> Perhaps<T>(Func<T?> value) => Maybe<T>.Perhaps(value());
    ...
    public static Attempt<TS> Failure<TS>() => Attempt<TS>.Failure(new EmptyException());

    public static Attempt Success() => Attempt.Success();
    public static Attempt Failure(Exception e) => Attempt.Failure(e);
    public static Attempt Failure() => Attempt.Failure(new EmptyException());
}
